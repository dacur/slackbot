...
class CrBot {
  ...
  onIncomingCodeReview(req, res, next) {
    ...
    let newCR;
    if (!githubPRParams) { return res.status(404).end(`Beep:Boop. I could not find your repo. Are you sure it is accessible to me? Please double check your URL: ${req.body.text}`); }
